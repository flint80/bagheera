...
![http://bagheera.googlecode.com/svn/trunk/help/using_program/figures/program_structure.png](http://bagheera.googlecode.com/svn/trunk/help/using_program/figures/program_structure.png)
...
Пары, которые добавляются в контекст при инициализации, описаны в разделе [Контекст](Context.md)