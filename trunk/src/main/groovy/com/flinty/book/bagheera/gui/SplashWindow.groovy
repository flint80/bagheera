 ...
 * @version $Id: SplashWindow.java,v 1.3 2007/01/20 15:01:52 ddimon Exp $
 */
final class SplashWindow extends Window {
	...
	private SplashWindow(final Frame parent, final Image anImage) {
		...
		setLocation(
				(int) (screenDim.width - imgWidth) / 2,
				(int) (screenDim.height - imgHeight) / 2
				)
	 ...
	 * @param image The splash image.
	 */
	static void splash(final Image image) {
